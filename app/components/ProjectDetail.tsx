          ...
          <div className="mx-6 md:mx-12 lg:mx-16 xl:mx-24">
            ...
            <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 mb-20 md:mb-28">
              ...
              <div className="lg:col-span-7">
                <h2
                  className="text-sm font-light tracking-[0.2em] text-neutral-400 uppercase mb-6"
                  style={{ fontFamily: "var(--font-body)" }}
                >
              ...
              <div className="lg:col-span-5 lg:pl-8 lg:border-l border-neutral-200">
                <div className="lg:sticky lg:top-32 space-y-10">
                  ...
                  <div>
                    <h3
                      className="text-sm font-light tracking-[0.2em] text-neutral-400 uppercase mb-4"
                      style={{ fontFamily: "var(--font-body)" }}
                    >
                    ...
                    <div className="flex flex-wrap gap-2">
                      {project.technologies.map((tech) => (
                        <span
                          key={tech}
                          className="bg-neutral-100 px-4 py-2 text-sm font-light tracking-wide text-neutral-700"
                          style={{ fontFamily: "var(--font-body)" }}
                        >
                          {tech}
                        </span>
                    ...
                    <div className="flex flex-wrap gap-3">
                      {project.liveUrl && (
                        <a
                          ...
                          className="group inline-flex items-center gap-2 bg-neutral-900 px-5 py-2.5 text-sm font-light tracking-wider text-white uppercase transition-all duration-300 hover:bg-neutral-800"
                          style={{ fontFamily: "var(--font-body)" }}
                        >
                      ...
                      {project.githubUrl && (
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="inline-flex items-center gap-2 border border-neutral-300 px-5 py-2.5 text-sm font-light tracking-wider text-neutral-700 uppercase transition-all duration-300 hover:border-neutral-900 hover:text-neutral-900"
                          style={{ fontFamily: "var(--font-body)" }}
                        >
              ...
              <div className="lg:col-span-8">
                <ul className="space-y-6">
                  {(projectTranslations?.features || project.features).map((feature, index) => (
                    ...
                    >
                      <span className="flex-shrink-0 mt-1.5 w-2 h-2 rounded-full bg-neutral-300 group-hover:bg-neutral-900 transition-colors" />
                      <p
          ...
          <Link href={`/projects/${nextProject.slug}`} className="group block">
            <div className="mx-6 md:mx-12 lg:mx-16 xl:mx-24 py-12 md:py-16">
              <div className="grid md:grid-cols-2 gap-6 lg:gap-12 items-center">
                ...
                <div>
                  <span
                    className="text-xs font-light tracking-[0.3em] text-neutral-500 uppercase mb-3 block"
                    style={{ fontFamily: "var(--font-body)" }}
                  >
                    {locale === "en" ? "Next project" : "Projet suivant"}
                  </span>
                  <h2
                    className="text-3xl md:text-4xl lg:text-5xl font-light tracking-tight text-white transition-all duration-500 group-hover:tracking-wide"
                    style={{ fontFamily: "var(--font-display)" }}
                  >
                    {nextProject.title}
                  </h2>
                  <div className="mt-5 flex items-center gap-3 text-neutral-500 transition-colors group-hover:text-white">
                    <span
